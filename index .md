<!DOCTYPE html>
<html lang="en"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>AIRo Trading Bot</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="css/airo.css">
<link rel="stylesheet" href="css/css.css">
<style>
body,h1,h2,h3,h4,h5 {font-family: "Open Sans", sans-serif}
body {font-size:16px;}
.airohalf img{margin-bottom:-6px;margin-top:16px;opacity:0.8;cursor:pointer}
.airohalf img:hover{opacity:1}
</style>
</head><body>

<!-- Sidebar/menu -->
<nav class="airosidebar airored airocollapse airotop airolarge airopadding" style="z-index: 3; width: 300px; font-weight: bold; display: none;" id="mySidebar">
  <!--<a href="javascript:void(0)" onclick="airo_close()" class="airobutton airohide-large airodisplay-topleft" style="width:100%;font-size:22px">
  </a>-->   
  <img src="images/close_icon_white.svg" onclick="airo_close()" class="airo_x_button  airohide-large airodisplay-topright" >

  <div class="airocontainer">
    <h3 class="airopadding-64"><img src="images/Airo_Trading_Bot_logo.svg" width="150px"></h3>
  ...
  <div class="airobar-block">
	...
	<p>
	<a href="#"><img src="images/fb_white_icon.svg" class="facebook"></a>
...
<div class="airomain" style="margin-left:340px;margin-right:40px">
  ...
  <div class="airorow-padding">
    ...
    <div class="airohalf">
      <img src="images/with_phone_airo.png" style="width:100%" onclick="onClick(this)" alt="AIRo Trading Bot log-in page">
...
nisi ut aliquip ex ea commodo consequat.
  ...
  <div class="airorow-padding airograyscale">
    ...
    <div class="airocol m4 airomargin-bottom">
      <div class="airolight-grey">
        <img src="images/team3.jpg" alt="Juan" style="width:100%">
        <div class="airocontainer">
          <h3>Juan D</h3>
...
nisi ut aliquip ex ea commodo consequat.
  ...
  <div class="airorow-padding">
    <div class="airohalf airomargin-bottom">
		<ul class="airoul airolight-grey airocenter"> <img class="android_icon" src="images/Android_robot.svg"></ul>
